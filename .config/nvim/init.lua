...
-- Highlights set after color scheme to avoid timing issues
...
vim.keymap.set({ 'n', 'i' }, '<M-p>', vim.diagnostic.goto_prev, { desc = 'Go to [P]revious diagnostic message' })
vim.keymap.set({ 'n', 'i' }, '<M-n>', vim.diagnostic.goto_next, { desc = 'Go to [N]ext diagnostic message' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      pcall(require('telescope').load_extension, 'restartlsp')
      ...
      vim.keymap.set('n', '<leader>lr', '<cmd>Telescope restartlsp<cr>', { desc = '[L]SP [R]estart' })
  ...
  { -- You can easily change to a different colorscheme.
    ...
    config = function()
      ...
      vim.api.nvim_set_hl(0, 'LineNrAbove', { fg = '#abb0ff' })
      vim.api.nvim_set_hl(0, 'LineNrBelow', { fg = '#abb0ff' })
    end,
  },
