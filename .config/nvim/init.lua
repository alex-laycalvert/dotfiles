...
vim.api.nvim_set_hl(0, 'LineNrAbove', { fg = '#7e83cd' })
vim.api.nvim_set_hl(0, 'LineNrBelow', { fg = '#7e83cd' })
...
vim.api.nvim_create_autocmd({ 'BufNewFile', 'BufRead' }, {
  ...
  desc = 'Treat gohtml files as html',
  callback = function()
    vim.cmd [[ setlocal filetype=tmux ]]
  end,
})
...
require('lazy').setup({
  ...
  require 'kickstart.plugins.autolist',
  require 'kickstart.plugins.neo-tree',
  require 'kickstart.plugins.gitsigns',
  require 'kickstart.plugins.git-worktree',
  require 'kickstart.plugins.notethankyou',
  require 'kickstart.plugins.csv',
...
vim.keymap.set('n', '<leader>n', '<cmd>noh<cr>', { silent = true, desc = 'Close Neovim' })
vim.keymap.set({ 'n', 'i', 'v' }, '<M-v>', '<cmd>vsplit<cr>', { desc = 'Vertical Split' })
...
vim.api.nvim_create_user_command('CopyRelativeFile', function()
  local file_name = vim.fn.expand '%:p'
  ...
  vim.fn.setreg('+', relative_file_name)
  print('Copied: ' .. relative_file_name)
end, { desc = 'Copy file path relative to current working directory to clipboard' })

vim.keymap.set('n', '<leader>yf', '<cmd>CopyFile<cr>', { silent = true, desc = 'Copy Full File Path' })
vim.keymap.set('n', '<leader>yr', '<cmd>CopyRelativeFile<cr>', { silent = true, desc = 'Copy Relative File Path' })
vim.keymap.set('n', '<leader>ls', '<cmd>luafile ~/.config/nvim/after/plugin/luasnip.lua<cr>', { silent = true, desc = '[L]oad [S]nippets' })
