...
vim.keymap.set({ "n", "i" }, "<M-S-k>", "ddkP", {})
vim.keymap.set({ "n", "i" }, "<M-S-j>", "ddp", {})
...
end, { desc = "Open File Tree Tab" })
vim.keymap.set({ "n", "i", "v" }, "<M-S-n>", function()
...
vim.keymap.set("n", "<leader>gc", "<cmd>Telescope conflicts<cr>", { desc = "Search [G]it [C]onflicts" })
